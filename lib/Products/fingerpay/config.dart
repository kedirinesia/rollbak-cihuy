...
import 'package:mobile/Products/fingerpay/layout/index.dart';

String sigVendor = '6117aa5e09db9218805ede63';

const namaApp = 'Fingerpay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.fingerpay.mobile';
String brandId;
String copyRight = '';
int templateCode = 4;
String gaId = '';
String apiUrl = 'https://fingerpay-app.findig.id/api/v1';
...
String apiUrlKasir = 'https://api-kasir.fingerpay.id/api/v1';
...
Map<String, String> assetGambar = {
  ...
  'logoLogin': 'https://dokumen.payuni.co.id/logo/fingerpay/login.png'
};
