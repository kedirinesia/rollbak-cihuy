                  ...
                  child: ListTile(
                    ...
                    leading: CircleAvatar(
                      child: CachedNetworkImage(
                          imageUrl:
                              'https://dokumen.payuni.co.id/logo/xenaja/tf.png'),
                      backgroundColor: Colors.transparent,
                    ),
                    title: Text('Transfer ke XenAja',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.bold)),
                    subtitle: Text('Kirim Saldo ke Member XenAja',
                        style:
                    ...
                    ? Container(
                        ...
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            child: CachedNetworkImage(
                                imageUrl:
                                    'https://dokumen.payuni.co.id/logo/xenaja/transfer.png'),
                            backgroundColor: Colors.transparent,
                          ),
