...
import 'package:mobile/Products/ampedia/layout/components/menuTool.dart';
import 'package:mobile/Products/ampedia/layout/profile.dart';
          ...
          ? SingleChildScrollView(
              child: Stack(
                children: <Widget>[
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: CachedNetworkImageProvider(
                                'https://ampedia.app/assets/images/mobile/header.png'),
                            fit: BoxFit.cover)),
                  ),
                  // Container(
                  //   width: double.infinity,
                  ...
                  //       colors: [Color(0xff843ce7), Color(0xff5c00d9)],
                  //       stops: [0, 1],
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                    imageUrl:
                                        'https://dokumen.payuni.co.id/logo/ampedia/putih.png',
                                    width: 24.0),
                              ),
                              Expanded(
                                child: Row(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Selalu Ada di AM Pedia',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Info Menarik dari AM Pedia',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Dapat Hadiah dari AM Pedia',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari AM Pedia',
                                style: TextStyle(
                                    fontSize: 11.0, color: Colors.grey[500])),
                          ),
                        ),
