...
String sigVendor = '67c015260d8877749225b873';

const namaApp = 'WarungPay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.warungpay.apkmobile';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/67c5355e0454a3190b79a05e/1ild5gv3f';
int otpCount = 4;
int pinCount = 4;
