...
import 'package:mobile/Products/apkpulsa2/layout/transaksi/postpaid.dart';
import 'package:mobile/Products/apkpulsa2/layout/transaksi/prepaid.dart';
...
import 'package:mobile/Products/apkpulsa2/layout/list_sub_menu.dart';
import 'package:mobile/Products/apkpulsa2/layout/transaksi/pulsa.dart';
...
class _MenuComponentState extends State<MenuComponent> {
  ...
  Future<List<MenuModel>> menus() async {
    ...
    items.add(
      MenuModel(
        jenis: 99,
        icon: 'https://fupulsa.com/img/iconapp/lainnya.png',
        name: 'Lainnya',
        type: 99,
      ),
    );
