...
class _SelectProvinsiPageState extends State<SelectProvinsiPage> {
  List<MarketplaceProvinsi> master = [];
  List<MarketplaceProvinsi> items = [];
  bool isLoading = true;
  ...
  void getItems() async {
    ...
    if (response.statusCode == 200) {
      ...
      datas.forEach((data) => master.add(MarketplaceProvinsi.fromJson(data)));
      items = master;
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Pilih Provinsi')),
      body: Container(
                  ...
                  children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (ctx, i) {
                              MarketplaceProvinsi item = items[i];
