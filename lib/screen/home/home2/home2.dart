...
import 'package:mobile/screen/home/home2/home2_model.dart';
...
class _Home2AppState extends Home2Model {
  @override
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child: Image.asset('assets/img/withdraw.png',
                        fit: BoxFit.cover, color: Colors.green[600]),
                  ),
                  SizedBox(height: 5.0),
                  Text('Withdraw',
                      style:
                          TextStyle(fontSize: 12.0, color: Colors.green[600]))
                ],
              ),
            ),
          ),
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    padding: EdgeInsets.all(8.0),
                    child:
                        Image.asset('assets/img/money.png', fit: BoxFit.cover),
                  ),
                  SizedBox(height: 5.0),
                  Text('Rewards',
                      style: TextStyle(
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    padding: EdgeInsets.all(8.0),
                    child: Image.asset('assets/img/order.png', width: 20.0),
                  ),
                  SizedBox(height: 5.0),
                  Text('Komisi',
                      style: TextStyle(
