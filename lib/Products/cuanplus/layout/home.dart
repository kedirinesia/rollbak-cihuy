...
import 'package:mobile/Products/cuanplus/layout/components/menuTool.dart';
import 'package:mobile/Products/cuanplus/layout/cs.dart';
import 'package:mobile/Products/cuanplus/layout/profile.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:mobile/Products/cuanplus/layout/components/banner.dart';
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                    imageUrl:
                                        'https://firebasestorage.googleapis.com/v0/b/payuni-2019y.appspot.com/o/merchants%2Fcuanplus%2Flogo%20(3).png?alt=media&token=57371e0f-fc9f-474a-ba26-ca53324a3ea8',
                                    width: 24.0),
                              ),
                              Expanded(
                                child: Row(
                        ...
                        Container(
                          ...
                          child: MenuDepan(grid: 5, radius: 10.0),
                        ),
                        SizedBox(height: 20.0),
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Cuan Plus Aplikasi Pembayaran Terkini',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            title: Text(
                                'Pakai Selalu Cuan Plus, Dapatkan Untungnya!',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 10.0),
                              Text(
                                  'Mengajak Teman Kamu Untuk Menggunakan Cuan Plus adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                                  style: TextStyle(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Dapat Hadiah dari Cuan Plus',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari Cuan Plus',
                                style: TextStyle(
                                    fontSize: 11.0, color: Colors.grey[500])),
                          ),
                        ),
