                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        title: Text('Selalu Ada di Payuni',
                            style: TextStyle(
                    ...
                    Container(
                      ...
                      child: ListTile(
                        title: Text('Info Menarik dari Payuni',
                            style: TextStyle(
                                fontSize: 13.0, fontWeight: FontWeight.bold)),
                        subtitle: Text(
                    ...
                    Container(
                      margin: EdgeInsets.only(right: 20),
                      child: ListTile(
                        title: Text('Dapat Hadiah dari Payuni',
                            style: TextStyle(
                                fontSize: 13.0, fontWeight: FontWeight.bold)),
                        subtitle: Text(
                            'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari Payuni',
                            style: TextStyle(
                                fontSize: 11.0, color: Colors.grey[500])),
                      ),
                    ),
