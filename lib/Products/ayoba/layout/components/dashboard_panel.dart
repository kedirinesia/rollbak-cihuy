...
import 'package:mobile/Products/ayoba/layout/qris/qris_page.dart';
import 'package:mobile/Products/ayoba/layout/topup.dart';
import 'package:mobile/Products/ayoba/layout/transfer.dart';
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => TransferPagePopay()));
                  },
