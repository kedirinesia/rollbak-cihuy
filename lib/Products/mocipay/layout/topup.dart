...
import 'package:mobile/Products/mocipay/layout/components/template.dart';
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        child: mm.icon.isNotEmpty ? Padding(
                      ...
                      title: Row(
                        ...
                        children: <Widget>[
                          Text(mm.title??' ', style: TextStyle(
                            fontSize: 12.0,
                            fontWeight: FontWeight.bold,
                            color: Colors.grey.shade700
                          )),
                          // mm.admin != null ? Text('+${mm.admin['satuan'] == 'persen' ? '': 'Rp '}${mm.admin['nominal']}${mm.admin['satuan'] == 'persen' ? '%': ''} (admin)', style: TextStyle(fontSize: 11, color: Colors.grey[800]),) : SizedBox()
                        ],
                      ),
                      subtitle: Text(mm.description??' ', style: TextStyle(
                        fontSize: 10.0,
                        color: Colors.grey.shade700
                      )),
                    ),
