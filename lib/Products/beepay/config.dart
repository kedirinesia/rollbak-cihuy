...
String sigVendor = '5f5369a055a61e299581d386';

const namaApp = 'Beepay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.beepay.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f5707a9f0e7167d000e4344/default';
int otpCount = 4;
int pinCount = 4;
