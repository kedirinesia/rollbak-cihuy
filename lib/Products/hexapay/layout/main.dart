...
import 'package:mobile/Products/hexapay/layout/home.dart';
import 'package:mobile/Products/hexapay/layout/profile.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:mobile/component/webview.dart';
import 'package:mobile/Products/hexapay/layout/history.dart';
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: CachedNetworkImage(
              imageUrl:
                  'https://dokumen.payuni.co.id/logo/hexapay/hexapayhomebiru.png',
              width: 100.0),
          backgroundColor: Colors.white,
          elevation: 0.0,
          actions: <Widget>[
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text('Downline', style: TextStyle(fontSize: 10.0))
                      ],
                    ),
                  ),
                ),
