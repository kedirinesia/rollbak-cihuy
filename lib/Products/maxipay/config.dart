...
String sigVendor = '67532a67c46c15b9542ec778';

const namaApp = 'MaxiPay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.maxipay.mobile';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://maxipay-app.findig.id/api/v1';
String liveChat = 'https://tawk.to/chat/6765276b49e2fd8dfefab6cf/1ifhi3vj6';
int otpCount = 4;
int pinCount = 4;
