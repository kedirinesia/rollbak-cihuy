...
import 'package:mobile/Products/hexamobile/layout/transfer.dart';
import 'package:mobile/Products/hexamobile/layout/qris/qris_page.dart';
import 'package:mobile/models/mp_kategori.dart';
import 'package:mobile/models/mp_produk.dart';
import 'package:mobile/models/user.dart';
import 'package:mobile/Products/hexamobile/layout/card_info.dart';
import 'package:mobile/bloc/Api.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';
import 'package:mobile/component/carousel-depan.dart';
import 'package:mobile/Products/hexamobile/layout/menudepan.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListTile(
              ...
              subtitle:
                  Text('Saldo HexaMobile', style: TextStyle(fontSize: isSmallScreen ? 8.0 : (isMediumScreen ? 9.0 : 10.0))),
            ),
          ),
          Expanded(
            child: ListTile(
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'Lihat Info Menarik dari HexaMobile Disini',
            style: TextStyle(
              fontSize: 12.0,
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        children: [
          topPanel(),
          header(),
          SizedBox(height: isSmallScreen ? 15 : (isMediumScreen ? 17 : 20)),
          CarouselDepan(
            viewportFraction: isSmallScreen ? .7 : (isMediumScreen ? .67 : .65),
            aspectRatio: isSmallScreen ? 2.8 / 1 : (isMediumScreen ? 2.9 / 1 : 3 / 1),
          ),
          MenuDepan(
