...
String sigVendor = '62454812ab9cd2d978c1fb7f';

const namaApp = 'Kuota.net';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'id.kuotanet.mobile';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/62454f590bfe3f4a8770a503/1fvfbrtir';
int pinCount = 4;
int otpCount = 4;
