...
class _DetailDepositState extends State<DetailDeposit> {
  ...
  void bayarDana() async {
    try {
      ...
      DebugHelper.debugPrint('Error sharing file: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.dep.type == 1) {
      ...
      methode = 'Qris';
    } else if (widget.dep.type == 9) {
      methode = 'QRIS Static';
    } else if (widget.dep.type == 7) {
      methode = widget.dep.vaname != null
          ? widget.dep.vaname.toUpperCase()
          : 'Payment Link';
    }
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              CachedNetworkImage(
                  imageUrl:
                      'https://dokumen.payuni.co.id/logo/xenaja/landscape.png',
                  width: 100.0),
              Row(
              ...
              ((widget.dep.type == 1 || widget.dep.type == 2) &&
                  ...
                  : SizedBox(),
              (widget.dep.type == 7 && widget.dep.status == 0)
                  ? TextButton(
                      onPressed: () async {
                        try {
                          DebugHelper.debugPrint('widget.dep.url_payment.toString()');
