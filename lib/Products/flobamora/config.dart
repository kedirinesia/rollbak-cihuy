...
String sigVendor = '628464ad7512e8835b96729f';

const namaApp = 'Flobamora Pulsa';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.flobamora.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/628460a37b967b11798fe8eb/1g3ahj0j3';
int pinCount = 4;
int otpCount = 4;
