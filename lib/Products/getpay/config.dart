...
String sigVendor = '5f5b2cb22147164bbf293f6d';

const namaApp = 'Getpay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.geetpay.app';
String brandId = '';
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f5b39c24704467e89ee0e76/default';
int otpCount = 4;
int pinCount = 4;
