...
class CategoryState extends State<CategoryPage> {
  ...
  void initState() {
    getData();
    super.initState();
    analitycs.pageView('/category/kasir', {
      'userId': bloc.userId.valueWrapper?.value,
      'title': 'Kategori Kasir',
    });
  }
  ...
  Future<void> getData() async {
    try {
      ...
      http.Response response = await http.get(
          Uri.parse('$apiUrlKasir/master/category/get?page=$page'),
          headers: {
    ...
    if (_formKey.currentState.validate()) {
      ...
      try {
        ...
        http.Response response =
            await http.post(Uri.parse('$apiUrlKasir/master/category/add'),
                headers: {
  ...
  void deleteItem(CategoryModel category) async {
    showDialog(
      context: context,
          ...
          TextButton(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  Map<String, dynamic> dataToSend = {'id_category': idCategory};

                  http.Response response = await http.post(
                      Uri.parse('$apiUrlKasir/master/category/delete'),
                      headers: {
                        'Content-Type': 'application/json',
                        'authorization': bloc.token.valueWrapper?.value,
                      },
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (ctx, i) {
                                ...
                                return Container(
                                  ...
                                  child: ListTile(
                                    title: Text(_category.nama,
                                        style: TextStyle(
                                            fontSize: 14.0,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.grey.shade700)),
                                    subtitle: Text(
                                        formatDate(_category.created_at,
