...
import 'package:mobile/Products/paymobileku/layout/agreement/privacy_page.dart';
import 'package:mobile/Products/paymobileku/layout/agreement/service_page.dart';
...
import 'package:mobile/Products/paymobileku/layout/invite/main.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => EditToko()));
            },
          ),
        ),
      ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () {
              // Only block when config explicitly disables invite link
