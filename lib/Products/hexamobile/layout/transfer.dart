...
import 'package:mobile/Products/hexamobile/layout/transfer-bank/daftar_transfer.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';

class TransferManuPage extends StatefulWidget {
  @override
  _TransferManuPageState createState() => _TransferManuPageState();
}

class _TransferManuPageState extends State<TransferManuPage> {
  @override
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text('Transfer ke HexaMobile',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.bold)),
                    subtitle: Text('Kirim Saldo ke Sesama Member HexaMobile',
                        style:
                    ...
                    ? Container(
                        ...
                        child: ListTile(
                          onTap: () => Navigator.of(context).push(
                            MaterialPageRoute(
                                builder: (context) => DaftarTransferPage()),
                          ),
                          leading: CircleAvatar(
                            child: CachedNetworkImage(
                                imageUrl:
