...
String sigVendor = '5fb246f180ec834afc0b7069';

const namaApp = 'Mitra Pulsa';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.mitrapulsa.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5fca1c3a920fc91564cd6cab/default';
int otpCount = 4;
int pinCount = 4;
