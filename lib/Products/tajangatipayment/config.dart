...
String sigVendor = '5f91319949381337809a8e36';

const namaApp = 'TAJANG ATI PAYMENT';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.tajangatipayment.androidmobile';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f8da990fd4ff5477ea720d5/default';
int otpCount = 4;
int pinCount = 4;
