...
String sigVendor = '5f11aae0d994223263dde0ad';

const namaApp = 'OK Pulsa';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.okpulsa.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.popay.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f11bb2ba45e787d128ba1af/default';
int otpCount = 4;
int pinCount = 4;
