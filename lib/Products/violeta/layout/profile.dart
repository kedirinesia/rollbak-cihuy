...
import 'package:mobile/Products/centralbayar/layout/downline/downline.dart';
import 'package:mobile/Products/violeta/layout/agreement/privacy_page.dart';
import 'package:mobile/Products/violeta/layout/agreement/service_page.dart';
...
class ProfilePageVioleta extends StatefulWidget {
  ProfilePageVioleta();
...
class _ProfilePageState extends State<ProfilePageVioleta> {
  @override
  void initState() {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          packageName == 'id.centralbayar.mobileapp'
              ? InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
