...
import 'package:mobile/Products/funfast/config.dart';
      ...
      if (refCodeController.text.isNotEmpty) {
        ...
        if (!alphanumeric.hasMatch(refCodeController.text)) {
          SnackBar snackBar = Alert(
              'Kode referral hanya mendukung Huruf, Angka, - (Dash/Strip) dan _ (Underscore)',
              isError: true);
        ...
        SnackBar snackBar =
            Alert('Kode referral tidak boleh kosong!', isError: true);
        ScaffoldMessenger.of(context).showSnackBar(snackBar);
      }
    } catch (e) {
      print(e);
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: "Masukan kode referral kamu",
                                    hintStyle: TextStyle(
                                      fontSize: 14.0,
                                      color: Colors.grey,
                                    ),
