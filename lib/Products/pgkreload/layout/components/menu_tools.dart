...
import 'package:mobile/Products/pgkreload/layout/transfer.dart';
                  ...
                  Expanded(
                    child: Align(
                      ...
                      child: InkWell(
                          ...
                          showModalBottomSheet(
                            ...
                            builder: (BuildContext context) {
                              List<Map<String, dynamic>> menus = [
                                ...
                                {
                                  'title': 'Terima Saldo',
                                  'icon': 'assets/img/payuni2/accept.svg',
                                  'action': () =>
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    GridView.builder(
                                      ...
                                      itemBuilder: (_, i) {
                                        Map<String, dynamic> menu = menus[i];
                        ...
                        child: Container(
                          // decoration: BoxDecoration(
                          //   borderRadius: BorderRadius.all(Radius.elliptical(15, 120)),
                          //   color: Theme.of(context).primaryColor.withOpacity(.1),
                          // ),
                          margin: const EdgeInsets.only(right: 10.0),
                          child: Icon(
