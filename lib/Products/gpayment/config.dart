...
String sigVendor = '5f3f32bae4a2100b426a820e';

const namaApp = 'G-Payment';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.gpayment.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.popay.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f4746361e7ade5df4444fa4/default';
int otpCount = 4;
int pinCount = 4;
