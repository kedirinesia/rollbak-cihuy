...
import 'package:mobile/Products/pandumedia/layout/banner.dart';
import 'package:mobile/Products/pandumedia/layout/card_info.dart';
import 'package:mobile/Products/pandumedia/layout/menudepan.dart';
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: CachedNetworkImage(
                  imageUrl: 'https://pandumedia.id/images/TF.png', width: 32.0),
            ),
          ),
          Container(
            width: 1.0,
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'Lihat Info Menarik dari Pandumedia Disini',
            style: TextStyle(
              fontSize: 12.0,
