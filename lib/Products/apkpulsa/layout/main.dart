...
import 'package:mobile/Products/apkpulsa/layout/home.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:mobile/component/webview.dart';
import 'package:mobile/Products/apkpulsa/layout/history.dart';
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: CachedNetworkImage(
              imageUrl: 'https://fupulsa.com/img/logohome.png', width: 100.0),
          backgroundColor: Colors.white,
          elevation: 0.0,
          actions: <Widget>[
            IconButton(
