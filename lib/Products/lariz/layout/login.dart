...
import 'package:mobile/Products/lariz/layout/forgot-password/step_1.dart';
import 'package:mobile/Products/lariz/layout/otp.dart';
import 'package:mobile/Products/lariz/layout/register.dart';
                  ...
                  children: [
                    SizedBox(
                        ...
                        child: CachedNetworkImage(
                            imageUrl:
                                'https://dokumen.payuni.co.id/icon/mbaid/logoweb2.png')),
                    const SizedBox(
                      height: 20,
                    ),
                    const Text(
