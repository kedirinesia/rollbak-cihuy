...
import 'package:mobile/Products/hexapay2/layout/components/dashboard_panel.dart';
import 'package:mobile/Products/hexapay2/layout/qris.dart';
import 'package:mobile/bloc/Api.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/component/rewards.dart';
import 'package:mobile/Products/hexapay2/layout/components/sticky_navbar.dart';
import 'package:mobile/Products/hexapay2/layout/components/carousel_header.dart';
import 'package:mobile/Products/hexapay2/layout/components/menu_depan.dart';
import 'package:mobile/Products/hexapay2/layout/components/carousel-depan.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        title: Text('Selalu Ada di Hexapay',
                            style: TextStyle(
                    ...
                    Container(
                      ...
                      child: ListTile(
                        title: Text('Info Menarik dari Hexapay',
                            style: TextStyle(
                                fontSize: 13.0, fontWeight: FontWeight.bold)),
                        subtitle: Text(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                              'Mengajak Teman Kamu Untuk Menggunakan Hexapay adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                              style: TextStyle(
                    ...
                    Container(
                      margin: EdgeInsets.only(right: 20),
                      child: ListTile(
                        title: Text('Dapat Hadiah dari Hexapay',
                            style: TextStyle(
                                fontSize: 13.0, fontWeight: FontWeight.bold)),
                        subtitle: Text(
                            'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari Hexapay',
                            style: TextStyle(
                                fontSize: 11.0, color: Colors.grey[500])),
                      ),
                    ),
