...
import 'package:mobile/Products/ayoba/layout/home1.dart';
import 'package:mobile/Products/ayoba/layout/profile.dart';
...
class HomeAyoba extends StatefulWidget {
  @override
  _HomeAyobaState createState() => _HomeAyobaState();
}

class _HomeAyobaState extends State<HomeAyoba> {
  int pageIndex = 0;
  List<Widget> halaman = [
    HomeAyoba1(),
    BelanjaPage(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Image.network(
          'https://dokumen.payuni.co.id/logo/payku/qris.png',
          color: Colors.white,
          width: 40.0,
          height: 40.0,
        ),
