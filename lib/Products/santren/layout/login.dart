        ...
        builder: (context, constraints) {
          return Column(
            children: [
              ...
              Center(
                child: configAppBloc.iconApp.valueWrapper?.value['logo'] != null
                    ? CachedNetworkImage(
              ...
              SizedBox(height: isSmallScreen ? screenHeight * 0.03 : screenHeight * 0.07),
                                ...
                                child: _loading
                                    ? SizedBox(
                                        ...
                                        child: CircularProgressIndicator(
                                          valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF4CAF00)),
                                          strokeWidth: 3,
                                        ),
                                      )
                                    : Text(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => configAppBloc.layoutApp.valueWrapper.value['register'] ?? RegisterUser(),
                                    ),
                                  );
                                },
                                child: Text(
