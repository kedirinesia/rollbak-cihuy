                  ...
                  child: ListTile(
                    ...
                    leading: CircleAvatar(
                      child: CachedNetworkImage(
                          imageUrl:
                              'https://dokumen.payuni.co.id/logo/mypay/tfmember.png'),
                      backgroundColor: Colors.transparent,
                    ),
                    title: Text('Transfer ke MyPay',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.bold)),
                    subtitle: Text('Kirim Saldo ke Member MyPay',
                        style:
                    ...
                    ? Container(
                        ...
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            child: CachedNetworkImage(
                                imageUrl:
                                    'https://dokumen.payuni.co.id/logo/mypay/tfbank.png'),
                            backgroundColor: Colors.transparent,
                          ),
