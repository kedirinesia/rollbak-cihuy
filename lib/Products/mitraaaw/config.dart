...
String sigVendor = '5f8e1a7c49381337809a8e2e';

const namaApp = 'Mitra AAW';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.mitraaaw.app';
String brandId = '';
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f8e1e66fd4ff5477ea73f1e/default';
int otpCount = 4;
int pinCount = 4;
