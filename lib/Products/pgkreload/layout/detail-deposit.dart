      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Container(
              margin:
                  EdgeInsets.only(top: 40.0, left: 10, right: 10, bottom: 20.0),
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: CachedNetworkImage(
                        imageUrl:
                            'https://dokumen.payuni.co.id/logo/pgkreload/logoland.png',
                        height: 50),
                  ),
                  SizedBox(height: 25),
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                          formatDate(
                              widget.dep.created_at, 'd MMMM yyyy HH:mm:ss'),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text('Total Bayar'),
                        Text(
                            formatRupiah(widget.dep.admin + widget.dep.nominal),
                            style: TextStyle(
                                color: Colors.black,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(formatDate(
                          widget.dep.expired_at, 'd MMMM yyyy HH:mm:ss'))
                    ],
                  ),
                  SizedBox(height: 10.0),
                  ((widget.dep.type == 1 || widget.dep.type == 2) &&
