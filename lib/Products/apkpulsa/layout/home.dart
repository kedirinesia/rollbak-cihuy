...
import 'package:mobile/Products/apkpulsa/layout/card_info.dart';
import 'package:mobile/bloc/Api.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';
import 'package:mobile/component/carousel-depan.dart';
import 'package:mobile/Products/apkpulsa/layout/menudepan.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListTile(
              ...
              subtitle:
                  Text('Saldo APK PULSA', style: TextStyle(fontSize: 10.0)),
            ),
          ),
          Expanded(
            child: ListTile(
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'Lihat Info Menarik dari APK PULSA Disini',
            style: TextStyle(
              fontSize: 12.0,
