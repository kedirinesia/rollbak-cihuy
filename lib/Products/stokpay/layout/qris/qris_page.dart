...
import 'package:mobile/Products/stokpay/layout/qris.dart';
import 'package:mobile/Products/stokpay/layout/qris/my_qr.dart';
...
class _QrisPageState extends State<QrisPage>
  ...
  Future<int> _getKycStatus() async {
    // Tempatkan logika untuk mendapatkan status KYC di sini.
