...
class VoucherReseller extends StatefulWidget {
  @override
  createState() => VoucherResellerState();
}

class VoucherResellerState extends State<VoucherReseller> {
  ...
  initState() {
    super.initState();
    analitycs.pageView('/voucher/reseller', {
      'userId': bloc.userId.valueWrapper?.value,
      'title': 'Voucher Reseller',
    });
    getList();
  }
  ...
  void onTapVoucher(VoucherMarket voucher) async {
