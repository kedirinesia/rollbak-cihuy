...
String sigVendor = '5ed770e602c3a351af14eda7';

const namaApp = 'SR Mobile';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'id.srmobile.co';
String brandId = '';
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.popay.id/api/v1';
String liveChat = 'https://tawk.to/chat/5edb0b2b9e5f6944228fffbe/default';
int otpCount = 4;
int pinCount = 4;
