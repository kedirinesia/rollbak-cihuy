...
import 'package:mobile/Products/mopay/layout/components/menuTool.dart';
import 'package:mobile/Products/mopay/layout/profile.dart';
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: CachedNetworkImageProvider(
                                'http://dokumen.payuni.co.id/icon/payaja/headerapp.png'),
                            fit: BoxFit.cover)),
                  ),
                  Container(
                    child: ListView(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                    imageUrl:
                                        'https://dokumen.payuni.co.id/icon/payaja/logowhite.png',
                                    width: 24.0),
                              ),
                              Expanded(
                                child: Row(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Selalu Ada di Mopay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Info Menarik dari Mopay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: CachedNetworkImageProvider(
                                      'http://dokumen.payuni.co.id/icon/payaja/footerapp.png'),
                                  fit: BoxFit.cover),
                              borderRadius: BorderRadius.circular(10.0)),
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 10.0),
                              Text(
                                  'Mengajak Teman Kamu Untuk Menggunakan Mopay adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                                  style: TextStyle(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Dapat Hadiah dari Mopay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari Mopay',
                                style: TextStyle(
                                    fontSize: 11.0, color: Colors.grey[500])),
                          ),
                        ),
                ...
                child: InkWell(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text('Support', style: TextStyle(fontSize: 10.0))
                    ],
                  ),
                ),
              ),
