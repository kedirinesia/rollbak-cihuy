...
import 'package:mobile/Products/mobipayment/layout/components/menuTool.dart';
import 'package:mobile/Products/mobipayment/layout/profile.dart';
import 'package:mobile/Products/mobipayment/layout/cs.dart';
...
class _HomePopayState extends State<HomeMobiPayment>
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                    imageUrl:
                                        'https://mobipayment.co.id/assets/images/logo/iconheader.png',
                                    width: 45.0),
                              ),
                              Expanded(
                                child: Row(
                              ...
                              // SizedBox(width : configAppBloc.isKasir.value ? 5.0 : 0.0),
                              // configAppBloc.isKasir.value ? InkWell(
                              //   onTap: () {
                              //     Navigator.of(context).pushNamed('/kasir');
                              //   },
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Selalu Ada di Mobipay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Info Menarik dari Mobipay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: CachedNetworkImageProvider(
                                      'https://www.payuni.co.id/img/appbar.png'),
                                  fit: BoxFit.cover),
                              borderRadius: BorderRadius.circular(10.0)),
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 10.0),
                              Text(
                                  'Mengajak Teman Kamu Untuk Menggunakan Mobipay adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                                  style: TextStyle(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Dapat Hadiah dari Mobipay',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari Mobipay',
                                style: TextStyle(
                                    fontSize: 11.0, color: Colors.grey[500])),
                          ),
                        ),
