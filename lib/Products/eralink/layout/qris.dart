                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: CachedNetworkImageProvider(
                                  "https://dokumen.payuni.co.id/logo/centralbayar/new/qris%20(1).png"),
                              fit: BoxFit.cover)),
                        ...
                        children: [
                          ...
                          Container(
                            child: CachedNetworkImage(
                              imageUrl:
                                  'https://dokumen.payuni.co.id/logo/centralbayar/rebranding/IconQris.png',
                          ...
                          Flexible(
                            child: Container(
                              child: CachedNetworkImage(
                                imageUrl:
                                    'https://dokumen.payuni.co.id/logo/ualreload/footer.png',
                                progressIndicatorBuilder: (_, __, ___) =>
                                    SpinKitFadingCircle(
                                  color: Theme.of(context).primaryColor,
                                ),
