...
String sigVendor = '63d22a4041d6a5bc8bfdb3be';

const namaApp = 'Agen Payment';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'id.agenpayment.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://agenpayment-app.findig.id/api/v1';
String liveChat = 'https://tawk.to/chat/63d2999d47425128790fcaf9/1gnnag52c';
int otpCount = 4;
int pinCount = 4;
