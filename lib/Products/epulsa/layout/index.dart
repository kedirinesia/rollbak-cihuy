...
import 'package:mobile/Products/epulsa/layout/home.dart';
import 'package:mobile/Products/epulsa/layout/history.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: configAppBloc.iconApp.valueWrapper?.value['logoLogin'] != null
            ? CachedNetworkImage(
                imageUrl:
                    'https://dokumen.payuni.co.id/logo/epulsa/logocloud.png',
                width: 75.0)
