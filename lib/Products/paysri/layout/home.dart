...
import 'package:mobile/Products/paysri/layout/components/menuTool.dart';
import 'package:mobile/Products/paysri/layout/profile.dart';
...
class _HomePopayState extends State<HomePopay> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     floatingActionButton: FloatingActionButton(
      //       backgroundColor: Theme.of(context).primaryColor,
      //       child : configAppBloc.isMarketplace.value ? Icon(Icons.shopping_cart_rounded): CachedNetworkImage(
      //           imageUrl:
      //               'https://firebasestorage.googleapis.com/v0/b/payuni-2019y.appspot.com/o/merchants%2Fpopay%2Fapk%2Fqr-code-scan%20(1).png?alt=media&token=9c6c8655-238f-4c93-9b1e-f5176a7d1dcb'),
      //       elevation: 0.0,
      //       onPressed : () async {
      //         if (configAppBloc.isMarketplace.value) {
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: CachedNetworkImageProvider(
                                'https://firebasestorage.googleapis.com/v0/b/payuni-2019y.appspot.com/o/merchants%2Fpayku%2FPayku.png?alt=media&token=fc4daea1-4762-4b3f-879f-f085d04f4178'),
                            fit: BoxFit.cover)),
                  ),
                  Container(
                    child: ListView(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: CachedNetworkImage(
                                    imageUrl:
                                        'https://paysri.id/download/logo-paysri-pure-white-100px.png',
                                    width: 24.0),
                              ),
                              Expanded(
                                child: Row(
                              ...
                              // InkWell(
                              //   onTap: () {
                              //     if (configAppBloc.liveChat.value != '') {
                              //       return Navigator.of(context).push(
                              //           MaterialPageRoute(
                              //               builder: (context) => Webview(
                              //                   'Live Chat Support',
                              //                   configAppBloc.liveChat.value)));
                              //     } else {
                              //       return null;
                              //     }
                              //   },
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Selalu Ada di PaySri',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Info Menarik dari PaySri',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 10.0),
                              Text(
                                  'Mengajak Teman Kamu Untuk Menggunakan PaySri adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                                  style: TextStyle(
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 20.0, right: 20.0),
                          child: ListTile(
                            title: Text('Dapat Hadiah dari PaySri',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                'Kumpulkan Poin Kamu dan Tukarkan dengan Reward yang Tersedia Dari PaySri',
                                style: TextStyle(
                                    fontSize: 11.0, color: Colors.grey[500])),
                          ),
                        ),
