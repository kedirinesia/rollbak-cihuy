...
import 'package:mobile/Products/ayoba/layout/komisi/tukar_komisi.dart';
...
import 'package:mobile/screen/kyc/sukses.dart';
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            onTap: () => Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (_) => TukarKomisi(
                                        bloc.user.valueWrapper?.value.komisi))),
                            title: Text('Komisi',
                                style: TextStyle(fontSize: 12.0)),
                            leading:
                          ...
                          Divider(),
                          ListTile(
                            onTap: () => _onVerificationButtonPressed(context),
                          ...
                          // ListTile(
                          //   onTap: () => Navigator.of(context).push(
                          //       MaterialPageRoute(builder: (_) => MyQR())),
                          //   title: Text('QR Code Saya',
                          //       style: TextStyle(fontSize: 12.0)),
                          //   leading:
                          //       Icon(Icons.qr_code_rounded, color: Colors.pink),
                          //   trailing: Icon(Icons.arrow_forward_ios),
                          // ),
                          // Divider(),
                          // ListTile(
