                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (value) {
                            int amount = int.tryParse(jumlahControl.text
                                    .replaceAll(RegExp('[^0-9]'), '')) ??
                                0;
                            jumlahControl.text = formatRupiah(amount);
                            jumlahControl.selection =
                                TextSelection.fromPosition(TextPosition(
                                    offset: jumlahControl.text.length));
                          },
                        ),
                      ),
                      Padding(
                          ...
                          itemBuilder: (_, int index) {
                            return InkWell(
                              onTap: () {
                                ...
                                jumlahControl.text =
                                    formatRupiah(tipsNominal[index]);
                              },
                              child: Container(
