...
String sigVendor = '5f50981d865d8b6844a36491';

const namaApp = 'Mocipay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.mocipay.app';
String brandId;
String copyRight = 'Mocipay Reload';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://mocipay-app.findig.id/api/v1';
String liveChat = '';
int otpCount = 4;
int pinCount = 4;
