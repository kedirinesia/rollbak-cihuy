...
class CustomerUpdate extends StatefulWidget {
  ...
  @override
  createState() => CustomerUpdateState();
}
...
class CustomerUpdateState extends State<CustomerUpdate> {
  ...
  void setData() async {
    namaController.text = widget.customer.nama;
    telpController.text = widget.customer.telp;
        ...
        body: CustomScrollView(slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
                title: Text('Ubah Pelanggan'), centerTitle: true),
          ),
          SliverList(
