...
String sigVendor = '5ff6cbfd6a9228f06628436f';

const namaApp = 'Payfast ID';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.payfast.apk';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.payuni.co.id/api/v1';
String liveChat = 'https://tawk.to/chat/5ff08ff6df060f156a936e35/1er1r4n29';
int otpCount = 4;
int pinCount = 4;
