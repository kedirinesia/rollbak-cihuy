...
import 'package:mobile/Products/easypay/layout/card_info.dart';
import 'package:mobile/Products/easypay/layout/components/banner.dart';
import 'package:mobile/Products/easypay/layout/kirim-saldo.dart';
import 'package:mobile/Products/easypay/layout/topup.dart';
import 'package:mobile/Products/easypay/layout/components/menu.dart';
        ...
        children: [
          ...
          InkWell(
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => ProfilePopay()),
            ),
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        'Hi, ${bloc.user.valueWrapper?.value.nama.split(' ')[0]}',
                        style: TextStyle(
                          fontSize: 10,
                          color: Colors.grey,
                        ),
                      ...
                      SizedBox(height: 2),
                      Text(
                        'Poin: ${bloc.user.valueWrapper?.value.poin}',
                        style: TextStyle(
                          fontSize: 9,
                          color: Colors.grey,
                        ),
