...
String sigVendor = '5f3baca6e4a2100b426a8207';

const namaApp = 'A2oPay Reload';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'id.a2opayreload.co';
String brandId = '';
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.popay.id/api/v1';
String liveChat = 'https://tawk.to/chat/5f3bc617b7f44f406e95b23f/default';
int otpCount = 4;
int pinCount = 4;
