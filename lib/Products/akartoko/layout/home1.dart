...
import 'package:mobile/Products/akartoko/layout/card_info.dart';
import 'package:mobile/Products/akartoko/layout/components/banner.dart';
import 'package:mobile/Products/akartoko/layout/kirim-saldo.dart';
import 'package:mobile/Products/akartoko/layout/topup.dart';
import 'package:mobile/Products/akartoko/layout/components/menu.dart';
...
class MobipayHome extends StatefulWidget {
  @override
  _MobipayHomeState createState() => _MobipayHomeState();
}

class _MobipayHomeState extends State<MobipayHome>
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 3),
                      Text(
                        'Perbanyak transaksi dan tukarkan poin dengan hadiah menarik',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          'Mengajak Teman Kamu Untuk Menggunakan $appName adalah Salah Satu Cara Untuk Mendapatkan Penghasilan Tambahan Buat Kamu',
                          style: TextStyle(
