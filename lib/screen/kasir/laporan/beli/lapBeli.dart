...
class LapBeliState extends State<LapBeli> {
  ...
  // DateTime selectedAwal = DateTime.now();
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == 200) {
          ...
          setState(() {
            page++;
            totalBeli = nominal != null ? nominal : 0;
          });
        } else {
          showDialog(
              context: context,
