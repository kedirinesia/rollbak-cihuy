...
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.indofintekdg.id/api/v1';
// String apiUrl = 'https://api.payuni.id/api/v1';
String liveChat = 'https://tawk.to/chat/63bd1243c2f1ac1e202c9f91/1gmd8umdk';
int otpCount = 4;
int pinCount = 4;
