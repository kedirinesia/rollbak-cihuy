...
String sigVendor = '5ef0726b95a5613359c4c97f';

const namaApp = 'Outlet Pay';
const labelSaldo = 'Saldo';
const labelPoint = 'Point';
String packagename = 'com.outletpay.app';
String brandId;
String copyRight = '';
int templateCode = 3;
String gaId = '';
String apiUrl = 'https://app.popay.id/api/v1';
String liveChat = 'https://tawk.to/chat/5efaf0a19e5f694422918fe4/default';
int otpCount = 4;
int pinCount = 4;
