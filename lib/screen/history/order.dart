...
class _HistoryOrderPageState extends OrderController
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (ctx, i) {
                            ...
                            return ListTile(
                              ...
                              title: Text(
                                  item.products.last.productName ??
                                      'Produk Dihapus',
                                  overflow: TextOverflow.ellipsis),
                              subtitle: Text(
                                  formatDate(
                                      item.createdAt, 'd MMMM yyyy HH:mm:ss'),
                                  style: TextStyle(
                                      fontSize: 11, color: Colors.grey)),
                              leading: CircleAvatar(
                                backgroundColor:
                                    item.status.color.withOpacity(.15),
                                child: Icon(item.status.icon,
