...
class _VerifikasiPinState extends VerifikasiPinController {
  ...
  void initState() {
    super.initState();
    analitycs.pageView('/seepays/verification/pin',
        {'userId': bloc.userId.valueWrapper?.value, 'title': 'Verifikasi PIN Seepays'});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Verifikasi PIN Seepays',
            style: TextStyle(
              color: packageName == 'com.lariz.mobile'
                  ? Theme.of(context).secondaryHeaderColor
                  : Theme.of(context).primaryColor,
      ...
      body: loading
          ...
          : Container(
              ...
              child: Center(
                ...
                children: <Widget>[
                  Image.asset('assets/seepaysicon.png',
