...
import 'package:mobile/Products/ayoba/layout/card_info.dart';
import 'package:mobile/bloc/Api.dart';
import 'package:mobile/bloc/Bloc.dart';
import 'package:mobile/bloc/ConfigApp.dart';
import 'package:mobile/Products/ayoba2/layout/banner.dart';
import 'package:mobile/Products/ayoba2/layout/menudepan.dart';
...
class _PakeAjaHomeState extends State<PakeAjaHome> {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListTile(
              ...
              subtitle: Text('Saldo Ayoba', style: TextStyle(fontSize: 10.0)),
            ),
          ),
          Expanded(
            child: ListTile(
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: CachedNetworkImage(
                  imageUrl: 'https://ayoba.co.id/dokumen/icon/code/TF.png',
                  width: 32.0),
            ),
          ),
          Container(
  ...
  Widget marquee() {
    return configAppBloc.info.valueWrapper?.value.marquee != null &&
            configAppBloc.info.valueWrapper?.value.marquee.active
        ? Container(
            height: 35.0,
            ...
            // child: Marquee(
            //   text: configAppBloc.info.valueWrapper?.value.marquee.message,
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'Lihat Info Menarik dari Ayoba Disini',
            style: TextStyle(
              fontSize: 12.0,
